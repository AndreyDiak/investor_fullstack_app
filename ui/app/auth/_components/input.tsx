...
export const AuthInput = ({ Icon, ...rest }: Props) => {
  return (
    <div className="bg-gray-200 flex items-center rounded-full relative">
      <input
        className="bg-transparent rounded-full peer focus:border-none focus:outline-none font-sans font-semibold 
      ...
      <Icon
        width={18}
        height={18}
        className="absolute left-6 peer-focus:text-emerald-600 transition duration-500 peer-focus:-translate-x-2 ease-in-out"
      />
    </div>
  );
};
